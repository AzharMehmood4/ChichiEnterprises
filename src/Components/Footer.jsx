        ...
        <div className="flex flex-wrap md:text-left text-center order-first justify-between">            
              ...
              <nav className="list-none mb-10">
                {footerLinks.map(
                  (link) => (
                    <li key={link.id}>
                      <Link to={link.path} className="text-gray-600 hover:text-gray-800">
                        {link.name}
                      </Link>
                    </li>
                  )
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
              ...
              <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-[#096BAC] border-0 py-2 px-6 focus:outline-none hover:bg-[#2F3E81] rounded">
                Subscribe
              </button>
            </div>
      ...
      <div className="bg-gray-100">
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col justify-between">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <img 
            className="w-10 h-10"
            src={Logo} alt="Chichi Enterprises" />
